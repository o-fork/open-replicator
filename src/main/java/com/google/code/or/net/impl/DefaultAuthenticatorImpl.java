 ...
 * @author Jingqi Xu
 */
public class DefaultAuthenticatorImpl implements Transport.Authenticator {
    //
    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultAuthenticatorImpl.class);
